...
if args.coulgau == 'coulomb':
    ...
    while error_norm > prec:
        ...
        K_spinorb1  = orb.apply_potential(1.0, K1, spinorb2, prec)
        K_spinorb2  = orb.apply_potential(1.0, K2, spinorb1, prec)
...
#####################################################END COULOMB & START GAUNT#######################################################################
    ...
    while error_norm > prec:
        ...
        #Definition of GJx
        GJ1_Re0 = Pua(cspinorb2_alpha20.real) * (2.0 * np.pi)
        GJ1_Re1 = Pua(cspinorb2_alpha21.real) * (2.0 * np.pi)
        GJ1_Re2 = Pua(cspinorb2_alpha22.real) * (2.0 * np.pi)


        GJ2_Re0 = Pua(cspinorb1_alpha10.real) * (2.0 * np.pi)
        GJ2_Re1 = Pua(cspinorb1_alpha11.real) * (2.0 * np.pi)
        GJ2_Re2 = Pua(cspinorb1_alpha12.real) * (2.0 * np.pi)
        
        
        GJ1_Im0 = Pua(cspinorb2_alpha20.imag) * (2.0 * np.pi)
        GJ1_Im1 = Pua(cspinorb2_alpha21.imag) * (2.0 * np.pi)     
        GJ1_Im2 = Pua(cspinorb2_alpha22.imag) * (2.0 * np.pi)


        GJ2_Im0 = Pua(cspinorb1_alpha10.imag) * (2.0 * np.pi)
        GJ2_Im1 = Pua(cspinorb1_alpha11.imag) * (2.0 * np.pi)     
        GJ2_Im2 = Pua(cspinorb1_alpha12.imag) * (2.0 * np.pi)
                
        
        GJ1_0 = cf.complex_fcn()
        GJ1_0.real = GJ1_Re0
        GJ1_0.imag = GJ1_Im0
        
        GJ1_1 = cf.complex_fcn()
        GJ1_1.real = GJ1_Re1
        GJ1_1.imag = GJ1_Im1

        GJ1_2 = cf.complex_fcn()
        GJ1_2.real = GJ1_Re2
        GJ1_2.imag = GJ1_Im2
    

        GJ2_0 = cf.complex_fcn()
        GJ2_0.real = GJ2_Re0
        GJ2_0.imag = GJ2_Im0
        
        GJ2_1 = cf.complex_fcn()
        GJ2_1.real = GJ2_Re1
        GJ2_1.imag = GJ2_Im1

        GJ2_2 = cf.complex_fcn()
        GJ2_2.real = GJ2_Re2
        GJ2_2.imag = GJ2_Im2


        #Definition of GKx
        GK1_Re0 = Pua(cspinorb2_alpha10.real) * (2.0 * np.pi)
        GK1_Re1 = Pua(cspinorb2_alpha11.real) * (2.0 * np.pi)
        GK1_Re2 = Pua(cspinorb2_alpha12.real) * (2.0 * np.pi)


        GK2_Re0 = Pua(cspinorb1_alpha20.real) * (2.0 * np.pi)
        GK2_Re1 = Pua(cspinorb1_alpha21.real) * (2.0 * np.pi)
        GK2_Re2 = Pua(cspinorb1_alpha22.real) * (2.0 * np.pi)

        
        GK1_Im0 = Pua(cspinorb2_alpha10.imag) * (2.0 * np.pi)
        GK1_Im1 = Pua(cspinorb2_alpha11.imag) * (2.0 * np.pi)
        GK1_Im2 = Pua(cspinorb2_alpha12.imag) * (2.0 * np.pi)

        
        GK2_Im0 = Pua(cspinorb1_alpha20.imag) * (2.0 * np.pi)
        GK2_Im1 = Pua(cspinorb1_alpha21.imag) * (2.0 * np.pi)
        GK2_Im2 = Pua(cspinorb1_alpha22.imag) * (2.0 * np.pi)
        
        
        GK1_0 = cf.complex_fcn()
        GK1_0.real = GK1_Re0
        GK1_0.imag = GK1_Im0

        GK1_1 = cf.complex_fcn()
        GK1_1.real = GK1_Re1
        GK1_1.imag = GK1_Im1

        GK1_2 = cf.complex_fcn()
        GK1_2.real = GK1_Re2
        GK1_2.imag = GK1_Im2


        GK2_0 = cf.complex_fcn()
        GK2_0.real = GK2_Re0
        GK2_0.imag = GK2_Im0

        GK2_1 = cf.complex_fcn()
        GK2_1.real = GK2_Re1
        GK2_1.imag = GK2_Im1

        GK2_2 = cf.complex_fcn()
        GK2_2.real = GK2_Re2
        GK2_2.imag = GK2_Im2


        # Calculation of necessary potential contributions to Hellmotz
        VG10 = orb.apply_complex_potential(1.0, GJ1_0, alpha_10, prec)
        VG11 = orb.apply_complex_potential(1.0, GJ1_1, alpha_11, prec)
        VG12 = orb.apply_complex_potential(1.0, GJ1_2, alpha_12, prec)
        GJ_spinorb1 = VG10 + VG11 + VG12


        VG20 = orb.apply_complex_potential(1.0, GJ2_0, alpha_20, prec)
        VG21 = orb.apply_complex_potential(1.0, GJ2_1, alpha_21, prec)
        VG22 = orb.apply_complex_potential(1.0, GJ2_2, alpha_22, prec)
        GJ_spinorb2 = VG20 + VG21 + VG22


        GK_spinorb1_0  = orb.apply_complex_potential(1.0, GK1_0, alpha_20, prec)
        GK_spinorb1_1  = orb.apply_complex_potential(1.0, GK1_1, alpha_21, prec)
        GK_spinorb1_2  = orb.apply_complex_potential(1.0, GK1_2, alpha_22, prec)
   

        GK_spinorb2_0  = orb.apply_complex_potential(1.0, GK2_0, alpha_10, prec)
        GK_spinorb2_1  = orb.apply_complex_potential(1.0, GK2_1, alpha_11, prec)
        GK_spinorb2_2  = orb.apply_complex_potential(1.0, GK2_2, alpha_12, prec)
    

        GK_spinorb1 = GK_spinorb1_0 + GK_spinorb1_1 + GK_spinorb1_2
        GK_spinorb2 = GK_spinorb2_0 + GK_spinorb2_1 + GK_spinorb2_2
        #print('K_spinorb1', K_spinorb1)
